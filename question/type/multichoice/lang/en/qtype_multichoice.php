...
$string['shuffleallbutlast'] = 'Shuffle all but last';
$string['shuffleallbutlast_help'] = 'If enabled, the last of the answer will stay the last whilst the other are going to be shuffled.';
