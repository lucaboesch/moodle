...
class quizaccess_seb extends access_rule_base {
    ...
    private function get_action_buttons(): string {
        ...
        if ($this->accessmanager->should_validate_config_key() && (($this->quiz->timeopen == 0 && $this->quiz->timeclose == 0) ||
                ($this->timenow > $this->quiz->timeopen && $this->timenow < $this->quiz->timeclose))) {
