...
$string['seb:manage_seb_showlaunchsebbutton'] = 'Change SEB quiz setting: Launch SEB button';
...
$string['seb_showlaunchsebbutton'] = 'Show "Launch Safe Exam Browser" button';
$string['seb_showlaunchsebbutton_help'] = 'If enabled, a "Launch Safe Exam Browser" button to launch Safe Exam Browser will be shown on the quiz start page.';
