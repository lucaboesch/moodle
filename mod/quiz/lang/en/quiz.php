...
$string['completionpass'] = 'Require pass grade';
$string['completionpassdesc'] = 'Student must achieve a passing grade to complete this activity';
$string['completiongraderequirement'] = 'Grade requirements';
$string['completiongraderequirement_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the quiz settings) or higher.';
...
$string['gradetopassnotset'] = 'This quiz does not yet have a pass grade set. It may be set in the Grade section of the quiz settings.';
$string['gradetopassmustbeset'] = 'Pass grade cannot be zero as this quiz has its completion method set to require pass grade. Please set a non-zero value.';
