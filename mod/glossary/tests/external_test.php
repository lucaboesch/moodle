...
class mod_glossary_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_entries_by_multilingual_term() {
        ...
        $e1 = $gg->create_content($g1, array('userid' => $u1->id, 'approved' => 1, 'concept' => '<span lang="en" class="multilang">cat</span><span lang="fr" class="multilang">chat</span>',
            'tags' => array('Cats', 'Dogs')));
        $e2 = $gg->create_content($g1, array('userid' => $u1->id, 'approved' => 1), array('<span lang="en" class="multilang">cat</span><span lang="fr" class="multilang">chat</span>', '<span lang="en" class="multilang">dog</span><span lang="fr" class="multilang">chien</span>'));
        $e3 = $gg->create_content($g1, array('userid' => $u1->id, 'approved' => 1), array('<span lang="en" class="multilang">dog</span><span lang="fr" class="multilang">chien</span>'));
        $e4 = $gg->create_content($g1, array('userid' => $u1->id, 'approved' => 0, 'concept' => '<span lang="en" class="multilang">dog</span><span lang="fr" class="multilang">chien</span>'));
        $e5 = $gg->create_content($g2, array('userid' => $u1->id, 'approved' => 1, 'concept' => '<span lang="en" class="multilang">cog</span><span lang="fr" class="multilang">chien</span>'), array('cat'));
