    ...
    protected static function get_default_types() {
        return array(
            ...
            'gtar' => array('type' => 'application/x-gtar', 'icon' => 'archive',
                    'groups' => array('archive'), 'string' => 'archive'),
            'tgz' => ['type' => 'application/x-gtar', 'icon' => 'archive', 'groups' => ['archive'], 'string' => 'archive'],
            'gz' => ['type' => 'application/x-gzip', 'icon' => 'archive', 'groups' => ['archive'], 'string' => 'archive'],
            'gzip' => ['type' => 'application/x-gzip', 'icon' => 'archive', 'groups' => ['archive'], 'string' => 'archive'],
